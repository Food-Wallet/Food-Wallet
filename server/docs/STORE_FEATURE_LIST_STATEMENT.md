...
- [x] 회원은 원하는 조건에 따라 매장 목록을 검색할 수 있다.
  - [x] 매장 타입, 매장명, 페이지 번호로 검색한다.
  - [x] 매장 타입 조건이 없으면 전체 조회를 한다.
  - [x] 매장명이 없으면 전체 조회를 한다.
  - [x] 매장명이 포함된 매장을 조회한다.
  - [x] 운영중인 매장을 우선으로 조회된다.
  - [x] [예외] 입력 받은 매장 타입이 서비스에서 지원하지 않으면 예외가 발생한다.
  - [x] [예외] 페이지 번호가 0 또는 음수라면 예외가 발생한다.

- [x] 회원은 매장을 상세 조회할 수 있다.
  - [x] 메뉴는 판매 상태가 `SELLING`, `HOLD`인 메뉴만 조회가 된다.
...
- [x] 사업자 회원은 운영하지 않는 본인의 매장을 영구 삭제할 수 있다.
...
- [ ] 회원은 마음에 드는 매장을 즐겨찾기에 등록할 수 있다.
  - [ ] 즐겨찾기를 한 매장의 즐겨찾기 수가 1 증가한다.

- [ ] 회원은 즐겨찾기에 등록한 매장을 취소할 수 있다.
  - [ ] 즐겨찾기를 한 매장의 즐겨찾기 수가 1 감소한다.
